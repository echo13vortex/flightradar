...
echo ""
echo "Další kroky:"
echo "  1. Uprav .env soubor:           nano .env"
echo "  2. Spusť první sběr dat:        source .venv/bin/activate && python main.py"
echo "  3. Spusť aplikaci:              bash start.sh"
echo "  4. Pro produkci (nginx):        bash setup-production.sh"
echo ""
